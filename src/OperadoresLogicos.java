public class OperadoresLogicos {
  ...
  public static void main(String[] args) {
    ...
    boolean muitoDependente = quantidadeDependente >= mediaDependente;

    System.out.println((salarioBaixo) && (muitoDependente));

    boolean recebeAuxilio = (salarioBaixo) && (muitoDependente);
